...
class PHPGocoinTestCase extends PHPUnit_Framework_TestCase
{
  ...
  public function testConstructor()
  {
    ...
    $this -> assertEquals(
      $client -> getClientId(), self::CLIENT_ID, 'Expect the Client ID to be set.'
    );
    $this -> assertEquals(
      $client -> getClientSecret(), self::CLIENT_SECRET, 'Expect the Client secret to be set.'
    );
  }
  ...
  public function testSetClientId()
  {
    ...
    $this -> assertEquals(
      $client -> getClientId(), 'dummy', 'Expect the Client ID to be dummy.'
    );
  }
  ...
  public function testSetClientSecret()
  {
    ...
    $this -> assertEquals(
      $client->getClientSecret(), 'dummy', 'Expect the Client secret to be dummy.'
    );
  }
  ...
  public function testSetToken()
  {
    ...
    $this -> assertEquals(
      $client -> getToken(), 'saltydog', 'Expect installed access token to remain \'saltydog\''
    );
  }
  ...
  public function testGetUser()
  {
    ...
    $this->assertEquals($class_name, 'User', 'Expect class.');
  }
  ...
  public function testGetInvoices()
  {
    ...
    $this -> assertEquals($class_name, 'Invoices', 'Expect class.');
  }
  ...
  public function testGetMerchant()
  {
    ...
    $this -> assertEquals($class_name, 'Merchant', 'Expect class.');
  }
  ...
  public function testGetAccounts()
  {
    ...
    $this -> assertEquals($class_name, 'Accounts', 'Expect class.');
  }
  ...
  public function testGetApiUrl()
  {
    ...
    $this -> assertEquals($url, $test_url, 'Expect url');
  }
  ...
  public function testCurl()
  {
    ...
    $this -> assertEquals(
      $curl_result==FALSE , TRUE, 'Expect Curl result'
    );
  }
  ...
  public function testSetEror()
  {
    ...
    $this -> assertEquals(
      $client -> getError(), $err_msg, 'Expect Error Message'
    );
  }
}
?>